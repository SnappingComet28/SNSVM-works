            ...
            Screen:
                ...
                MDCard:
                    ...
                    MDRelativeLayout:
	                    ...
	                    Image:
	                    	source:"/storage/emulated/0/register.png"
                ...
                MDCard:
                    ...
                    MDRelativeLayout:
	                    ...
	                    Image:
	                    	source:"/storage/emulated/0/msg.png"
	                    	pos_hint:{"center_x":0.5,"center_y":0.376}
                MDCard:
                	padding:"20dp"
                	size_hint:None,None
                    ...
                    MDRelativeLayout:
	                    MDLabel:
	                    	...
	                    	pos_hint:{"center_x":0.7,"center_y":0.9999}
	                    Image:
	                    	source:"/storage/emulated/0/Ord.png"
                    ...
                    ScrollView:
                        ...
                        GridLayout:
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo13.png"
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo12.png"
                               		 pos_hint :{"center_x":0.5,"center_y":0.8}
                               		 size_hint:None,None
                               		 size:"150dp","150dp"
                               	 MDLabel:
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo11.png"
                               		 pos_hint :{"center_x":0.5,"center_y":0.8}
                               		 size_hint:None,None
                               		 size:"150dp","150dp"
                               	 MDLabel:
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo10.png"
                               		 pos_hint :{"center_x":0.5,"center_y":0.8}
                               		 size_hint:None,None
                               		 size:"150dp","150dp"
                               	 MDLabel:
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo9.png"
                               		 pos_hint :{"center_x":0.5,"center_y":0.8}
                               		 size_hint:None,None
                               		 size:"150dp","150dp"
                               	 MDLabel:
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo8.png"
                               		 pos_hint :{"center_x":0.5,"center_y":0.8}
                               		 size_hint:None,None
                               		 size:"150dp","150dp"
                               	 MDLabel:
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo14.png"
                            ...
                            MDCard:
                                ...
                                MDRelativeLayout:
                                	Image:
                                		source: "/storage/emulated/0/logo15.png"
                               		 pos_hint :{"center_x":0.5,"center_y":0.8}
                               		 size_hint:None,None
                               		 size:"150dp","150dp"
                               	 MDLabel:
...
db=dbx.Dropbox("slBqBZszXdRrDTOcUaC8duoMxf2uvDx0qzoZMGqARfhNRUbbPrKPOs_sY2IIaKP4pTwyLJaOuwZIBwq4_LqeU5aTN9BZNZJqNN4UOJzHR8r3eEeoAkD0uXR")
...
class MyApp(MDApp):
    ...
    def info(self):
        ...
        img_path = f"/storage/emulated/0/qr{len(qrcode) + 1}.png"
        with open("file.txt", "a") as file:
            file.write(text1 + "\n")
        self.change_screen("temp")
        img = qr.make(text1)
        img.save(img_path)
        card = MDCard(size_hint=(None, None), size=(900, 600), pos_hint={"center_x": 0.3, "center_y": 0.8}, elevation=4)
    ...
    def doc_list(self):
        for i in range(1, 20):
            ...
            doc_photo = Image(
                source="/storage/emulated/0/doc1.png",
    ...
    def request(self):
        ...
        try:
                req = "ReQuEsT"                
                db.files_upload(req.encode('utf-8'), "/test/dropbox.txt", mode=dbx.files.WriteMode('overwrite'))
